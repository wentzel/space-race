 ...
 *   RocketPanel.
 * 
 * - Spelarna kan n återigen gå diagonalt.Blir dock inte helt snyggt eftersom
 ...
 *   en vägg upåt och man håller ner vänster och uppåt (getNextLocation ser
 *   ju att det är en vågg snett uppåt vänster)
 * 
 ...
 *   och returnerar sedan rött bild.
 * 
 * FÖRE INLÄMNING:
 * 
 * 
 ...
 * 
 * *********** TOMS PILL TIS 11/1 *************
 * - Nu kan man gå igenom spåket när det är genomskinligt. (Opacity < 0.3f,
 ...
 * 
 * Måste ockå fixa vad som händer om sugaren har med sig en del som den
 ...
 * - Applet - Försäkt, problem med rättigheter för att öppna bilder
 ...
 * - Fixade spelarnamn. Man för skriva in dem i början av varje spel
 *   Om man har restartad så är default namnen från förra spelet. Detta lästes
 ...
 *   komma först! Tredje gången vi gör i denna fällla.... Ett alternativ
 ...
 *   kodningen av alla nya raketdelar nåra spelare 1. Bra att kunna återställa
 *   senare.
 * 
 ...
 * 
 * - Fixat aboutWindow som öppnas när man klickar på en knapp. Spelet pausas,
 ...
 *   bättre) som anropas när man trycker på space. Om man bör på något anropas
 ...
 *   samma metod.
 * 
 * - Läste på egen hand problem med hur vi kommer åt den statiska mainWorld:
 *   I stället för:
 ...
 *   När knappen läggs till för den automatiskt focus.
 ...
 *   som händer när vi går till en ny ruta är att den läggs till
 *   travelledPath. När vi poppar den för vi alltså bara tillbaks samma
